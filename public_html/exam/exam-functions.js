...
function getAllLanguageSelectors() {
    return document.querySelectorAll(".language-selector");
}
...
function loadStudentQuestionSelector() {
    ...
    const text = language === "english" ? "Pick a question..." : "Velg et spørsmål...";
    addSelectOption(selector, text, 0);
...
function setupEventHandlers() {
    getAllLanguageSelectors().forEach(selector => selector.addEventListener("click", handleLanguageChange));
