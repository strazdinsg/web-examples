        ...
        questions: [
            ...
            },
            {
                english: {
                    ...
                    description: "explain the goal and give some examples of how we can take care of website accessibility.",
                    sub: []
                },
                norsk: {
                    main: "Universell utforming og accessibility",
                    description: "forklar målet og gi noen eksampler på hvordan vi kan passe på accessibility av websider.",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "explain how web browsers locate resources on web servers.",
                    sub: ["Browsers", "Web servers", "Web addresses (URLs)", "HTTP protocol"]
                },
                norsk: {
                    main: "Web servere og browsere",
                    description: "forklar hvordan web browsere finner resursser som ligger på web tjenere.",
                    sub: ["Browsers", "Web servers", "Web adresser (URL)", "HTTP protokoll"]
                }
            },
            {
                english: {
                    main: "REST API",
                    description: "Explain the main concept of REST API and the conventions",
                    sub: ["Main idea", "CRUD operations", "URL conventions", "HTTP method conventions"]
                },
                norsk: {
                    main: "REST API",
                    description: "Forklar konseptet og konvensjoner av REST API",
                    sub: ["Hovedideen", "CRUD operasjoner", "URL konvensjoner", "HTTP metodekonvensjoner"]
                }
            },
            {
                english: {
                    main: "Web application architectures",
                    description: "explain the advantages and drawbacks of monolith- versus microservice architecture",
                    sub: []
                },
                norsk: {
                    main: "Arkitektur av webapplikasjoner",
                    description: "forklar fordeler og ulemper av monolit- kontra mikrotjenestearkitektur",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "describe the tools a programmer can use for development, testing and debugging of web applications.",
                    sub: []
                },
                norsk: {
                    main: "Utviklers verktøykasse",
                    description: "beskriv verktøy som en programmerer kan bruke for utvikling, testing og debugging av websider.",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "explain the 6 Normans usability principles, give examples how it can be used for web design.",
                    sub: ["Visibility", "Feedback", "Constraints", "Mapping", "Consistency", "Affordance"]
                },
                norsk: {
                    main: "Don Normans usability prinsipper",
                    description: "forklar Normans 6 usability prinsipper, gi noen eksempler hvordan de kan brukes for webdesign.",
                    sub: ["Visibility", "Feedback", "Constraints", "Mapping", "Consistency", "Affordance"]
                }
            },
            {
                english: {
                    ...
                    description: "how can designers use typography (font) to make effective websites?",
                    sub: []
                },
                norsk: {
                    main: "Webdesign: font",
                    description: "hvordan kan designere bruke typografi (font) for å lage effektive websider?",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "how can designers use color to make effective websites?",
                    sub: []
                },
                norsk: {
                    main: "Webdesign: farger",
                    description: "hvordan kan designere bruke farger for å lage effektive websider?",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "how can designers use images to make effective websites?",
                    sub: []
                },
                norsk: {
                    main: "Webdesign: bilder",
                    description: "hvordan kan designere bruke bilder for å lage effektive websider?",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "explain the concept of visual hierarchy and give some examples of what techniques can be used to achieve the desired hierarchy of content",
                    sub: []
                },
                norsk: {
                    main: "Webdesign: visuell hierarki",
                    description: "forklar konseptet 'Visual hierarchy' and gi noen eksempler av teknikker som kan brukes for oppnå ønsket hierarki av innholdet",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "describe the process of deploying a website on a publicly accessible server",
                    sub: []
                },
                norsk: {
                    main: "Deployment av websider",
                    description: "beskriv deploymentprosessen av en webside på en offentlig server",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "explain how stateful authentication (sessions) work for websites",
                    sub: []
                },
                norsk: {
                    main: "Sessjonsautentisering",
                    description: "forklar hvordan 'stateful' autentisering (sesjoner) fungerer for websider)",
                    sub: []
                }
            },
        ]
        ...
        questions: [
            ...
            },
            {
                english: {
                    ...
                    sub: ["DOM tree", "DOM elements", "DOM element attributes", "`id` and `class` attributes"]
                },
                norsk: {
                    main: "Document Object Model (DOM)",
                    description: "beskriv konsepter relaterte til DOM.",
                    sub: ["DOM tree", "DOM elementer", "attributter av DOM elementer", "`id` og `class` attributter"]
                }
            },
            {
                english: {
                ...
                norsk: {
                    ...
                    sub: ["DOM elementer som blokker", "inline kontra block", "eksempler"]
                }
            },
            {
                english: {
                    main: "Quality assurance",
                    description: "What tools and techniques can web developers use to ensure quality of the code they write?",
                    sub: []
                },
                norsk: {
                    main: "Kvalitetsikring",
                    description: "hvilke verktø og teknikker kan webutviklere bruke for sikring av kvalitet i koden de skriver?",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "explain the concept of semantic HTML elements and give some examples.",
                    sub: []
                },
                norsk: {
                    main: "Semantiske HTML elementer",
                    description: "forklar konseptet av semantiske HTML elementer og gi noen eksempler.",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    description: "choose some of widely used HTML elements and say a bit about their purpose and specifics.",
                    sub: []
                },
                norsk: {
                    main: "Populære HTML elementer",
                    description: "velg noen av ofte brukte HTML elementer, si litt om deres formål og hva som er spesielt med dem.",
                    sub: []
                }
            },
            {
                english: {
                    ...
                    sub: ["anchor elements", "relative and absolute links", "links to sections (fragments)"]
                },
                norsk: {
                    main: "HTML lenker",
                    description: "beskriv lenker til dokumenter (filer) i HTML.",
                    sub: ["ankerelementer", "relative og absolutte lenker", "lenker til seksjoner (fragmenter)"]
                }
            },
            {
                english: {
                    main: "Text markup",
                    description: "describe principles and give some examples of text markup.",
                    sub: []
                },
                norsk: {
                    main: "Tekstmarkering",
            ...
            },
            {
                english: {
                    ...
                    sub: ["How to include images?", "Popular image file formats for websites"]
                },
                norsk: {
                    main: "Bilder i HTML",
                    description: "bruk av bilder i websider.",
                    sub: ["Hvordan inkluderer man bilder?", "Populære filformater for bilder til websider"]
                }
            },
            {
                english: {
                    main: "Multiple alternative images in HTML",
                    description: "describe the options web developers have for use of different (adapted) images for users with different screen sizes",
                    sub: []
                },
                norsk: {
                    main: "Flere bildealternativer i HTML",
                    description: "beskriv muligheter som webutviklere har for bruk av forskjellige (tilpassede) bilder for brukere med ulike skjermstørrelser",
                    sub: []
                }
            },
            {
        ...
        questions: [
            ...
            },
            {
                english: {
                    ...
                    sub: ["by element type", "by class", "one specific element", "applying styles to selected elements"]
                },
                norsk: {
                    main: "CSS Selectors",
                    description: "hvordan selektere og sette stil til ønskede elementer?",
                    sub: ["elementer av konkret type", "elementer med konkret klasse", "en spesifikt element", "sette stil til valgte elementer"]
                }
            },
            {
                english: {
                    main: "CSS specificity and inheritance",
                    description: "explain how style inheritance works in CSS and how specificity can be used to override styles",
                    sub: []
                },
                norsk: {
                    main: "CSS 'spesifisitet' (specificity) og arv",
                    description: "forklar hvordan arv av stiler fungerer med CSS og hvordan man bruker spesifisitet for å overstyre stiler",
                    sub: []
                }
            },
            {
            ...
            },
            {
                english: {
                    ...
                    description: "explain the normal flow and other positioning methods with CSS.",
                    sub: ["Normal flow", "Floating to left/right", "Absolute and relative position"]
                },
                norsk: {
                    main: "Innholdsflyt og posisjonering",
                    description: "forklar normale flyten (normal flow) av innholdet og andre posisjoneringsmetoder med CSS.",
                    sub: ["Normal flow", "Floating til venstre/høyre", "Absolut og relativt posisjonering"]
                }
            },
            {
                english: {
            ...
            },
            {
                english: {
                    main: "Media queries",
                    description: "explain how media queries can be used for responsive websites.",
                    sub: []
                },
                norsk: {
                    main: "Media queries",
                    description: "forklar hvordan man bruker 'media queries' for å lage responsive websider.",
                    sub: []
                }
            },
        ]
    ...
    js: {
        ...
        questions: [
            ...
            },
            {
                english: {
                    main: "Frameworks",
                    description: "the purpose and advantages of using Javascript frameworks.",
                    sub: []
                },
                norsk: {
                    main: "Rammeverk",
            ...
            },
            {
                english: {
                    ...
                    description: "explain how stateless authentication with tokens work. Use JSON Web Token (JWT) as an example.",
                    sub: []
                },
                norsk: {
                    main: "Token-autentisering",
                    description: "forklar hvordan 'stateless' autentisering med tokens fungerer. Bruk JSON Web Token (JWT) som et eksempel.",
                    sub: []
                }
            },
        ]
