...
export function ShoppingCart() {
    ...
    for (let itemId in cart) {
        ...
        totalPrice += price;
        const itemRow = <tr className="cart-item" key={itemId}>
            ...
            <td className="cart-item-action"><DeleteCartItemButton id={"" + item.product.id}/></td>
        </tr>;
        ...
        cartContent =
            <table className="cart-table">
                ...
                <tr className="total-price-row">
                    <td className="total-price-title" colSpan="2">Total:</td>
                    <td className="total-price-value">{totalPrice.toFixed(2)} Kr</td>
                    <td className="cart-item-action"><DeleteCartItemButton id={DELETE_ALL}/></td>
                </tr>
                </tbody>
            </table>;
    } else {
